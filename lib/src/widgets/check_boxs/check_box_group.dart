...
class AgnesCheckBoxGroup extends StatefulWidget {
  ...
  /// 체크박스 그룹의 세로축 정렬 값을 지정합니다.
  final MainAxisAlignment mainGroupAlignment;

  /// 체크박스 그룹의 가로축 정렬 값을 지정합니다.
  ...
  @override
  State<AgnesCheckBoxGroup> createState() => _AgnesCheckBoxGroupState();
}

class _AgnesCheckBoxGroupState<T> extends State<AgnesCheckBoxGroup> {
  List<bool?>? _values;
  @override
  initState() {
    super.initState();
        ...
        return AgnesCheckBoxItem(
          ...
          onChanged: !widget.enabled
              ...
              : widget.onChanged != null
                  ? (selected) {
                      setState(() {
                        _values?[index] = selected;
                      });
                      widget.onChanged!(selected, index, _values);
                    }
                  : null,
